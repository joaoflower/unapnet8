...
<?
	...
	if(fsafetylogin())
	{
		...
		$vQuery .= "where es.num_mat = '{$_SESSION['sUsercod_usu']}' and es.cod_car = '{$_SESSION['sUsercod_car']}' ";
...
<form action="#" method="post" enctype="multipart/form-data" name="fData" id="fData">
	...
	<table border="0" cellspacing="0" cellpadding="0">
	  <tr>
		<td>
			<div class="dboton"><a href="" onClick = "std_savemidata(document.fData); return false;" class="isave" title="Guardar Datos">Guardar</a></div>
