  ...
  <table border="0" cellpadding="0" cellspacing="0" class="tventana">
	  ...
	  <tr>
		...
		<td align="center">
			...
			<?
			$tSilabo = "silaok".$_SESSION['sSilaano_aca'];
			...
			?>
				<tr <?=ftrstyle($vCont)?>  onMouseOver="mouseover(this)" onMouseOut="mouseout(this)">
				  ...
				  <td <?=ftdstyle($vNum_rows, $vCont)?>><?=ucwords(strtolower($aResult['car_des']))?></td>
		  	      <td <?=ftdstyle($vNum_rows, $vCont)?>><a href="" onclick="si2_updsilabo('<?=$aResult['cod_car']?>', '<?=$aResult['pln_est']?>', '<?=$aResult['cod_cur']?>', '<?=$aResult['sec_gru']?>', '<?=$aResult['mod_mat']?>'); return false;" class="enlaceb"><img src="../images/edit.png" alt="Modificar Silabo" width="16" height="16" /></a></td>
				  <td <?=ftdstyle($vNum_rows, $vCont)?>>
                  <!--<a href="" onclick="si2_delsilabopre('<?=$aResult['cod_car']?>', '<?=$aResult['pln_est']?>', '<?=$aResult['cod_cur']?>', '<?=$aResult['sec_gru']?>', '<?=$aResult['mod_mat']?>'); return false;" class="enlaceb"><img src="../images/drop.png" alt="Eliminar Silabo" width="16" height="16" /></a> -->
                  </td>
				</tr>
			<? 
				$vCont++; 	
	...
	?>
		<table border="0" cellspacing="0" cellpadding="0">
		  <tr>
			<td><div class="dboton"><a href="" onclick = "si2_newsilabo(); return false;" class="inew" title="Nuevo Silabo">Nuevo Sil.</a></div>
			</td>
		  </tr>
		</table>	
	<?
