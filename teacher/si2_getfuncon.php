...
<?
	...
	if(fsafetylogin())
	{
		...
		if(!empty($_POST['rEmail'])and !empty($_POST['rEsp_doc'])and !empty($_POST['rCod_amb']))
		{
			$vQuery = "update docente set email = '{$_POST['rEmail']}', ";
	  ...
	  <tr>
		...
		<td align="center"><div id="dsilabo">
		  <table border="0" cellpadding="0" cellspacing="0" bordercolor="#FF0000" class="tlistdata">
			...
			<table border="0" cellspacing="0" cellpadding="0">
			  <tr>
				<td><div class="dboton"><a href="" onclick = "si2_getcompe(document.fData); return false;" class="icontinue" title="Continuar">Continuar</a></div>
