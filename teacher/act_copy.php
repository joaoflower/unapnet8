...
<?
	...
	if(fsafetylogin())
	{
		...
		echo $vQuery .= "ingresado = 'T' ";
		
/*		$cIngnota = fQuery2($vQuery);
		while($aIngnota = mysql_fetch_array($cIngnota))
		{
			$_SESSION['sActacod_car'] = $aIngnota['cod_car'];
			echo $_SESSION['sActapln_est'] = $aIngnota['pln_est'];
			echo $_SESSION['sActacod_cur'] = $aIngnota['cod_cur'];
			$_SESSION['sActamod_mat'] = $aIngnota['mod_mat'];
			$_SESSION['sActasec_gru'] = $aIngnota['sec_gru'];			
			echo "<br>";
