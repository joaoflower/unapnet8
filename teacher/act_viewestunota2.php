...
<?
	if(fsafetylogin())
	{
		...
		{
			if($_POST['rCod_car'] == '04' or $_POST['rCod_car'] == '27' or $_POST['rCod_car'] == '29' or $_POST['rCod_car'] == '32')
				$_SESSION['sActaend_ing'] = 'F';
			else
				$_SESSION['sActaend_ing'] = 'T';

			if($_SESSION['sUsercod_usu'] == '970482' or $_SESSION['sUsercod_usu'] == '980523' or $_SESSION['sUsercod_usu'] == '1030622' or $_SESSION['sUsercod_usu'] == '951103'  or $_SESSION['sUsercod_usu'] == '83125' or $_SESSION['sUsercod_usu'] == '2004527'  or $_SESSION['sUsercod_usu'] == '72116' or $_SESSION['sUsercod_usu'] == '920631' or $_SESSION['sUsercod_usu'] == '980538' or $_SESSION['sUsercod_usu'] == '2001620' or $_SESSION['sUsercod_usu'] == '2004102' or $_SESSION['sUsercod_usu'] == '220011' or $_SESSION['sUsercod_usu'] == '980505'  or $_SESSION['sUsercod_usu'] == '920642' or $_SESSION['sUsercod_usu'] == '920642' or $_SESSION['sUsercod_usu'] == '2200748' or $_SESSION['sUsercod_usu'] == '87011'  or $_SESSION['sUsercod_usu'] == '2081232' or $_SESSION['sUsercod_usu'] == '950619'  or $_SESSION['sUsercod_usu'] == '90105' or $_SESSION['sUsercod_usu'] == '980525' )
				$_SESSION['sActaend_ing'] = 'F';			
		}
		else
		{
